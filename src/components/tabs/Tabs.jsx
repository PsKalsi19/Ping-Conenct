...
const Tabs = ({handleTabChange,tabTypes}) => {
  return (
    <div className="w-full pb-4 bg-orange-100 dark:bg-stone-900 sm:px-0">
         ...
         {tabTypes.map((tab,index)=>  <Tab key={index}
            className={({ selected }) =>
              classNames(
                ...
                'ring-orange-200 hover:bg-orange-100 dark:hover:bg-stone-600 dark:ring-stone-600 dark:ring-offset-stone-600 capitalize ring-opacity-60 ring-offset-2 ring-offset-orange-200 focus:outline-none focus:ring-2',
                selected

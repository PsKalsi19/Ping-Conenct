...
function Navbar() {
    ...
    return (
        ...
        <nav className={`sticky left-0  top-0 right-0 z-20 ${!top && ` backdrop-blur-xl border-b border-gray-50 shadow-sm`}`}>
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
              ...
              {NAVIGATION_LINKS.map(({ name, link }) => <NavLink
                ...
                {name}
                        ...
                        <h2 className="mb-4 text-xl font-extrabold leading-none tracking-tight text-gray-700 md:text-2xl">Home</h2>
                        ...
                        <Popover className="relative">
                            {({ open }) => (
                                <>
                                    <Popover.Button className="focus:outline-0">
                                        ...
                                        {open ? <XMarkIcon className="w-6 h-6 text-gray-500" />
                            ...
                            >
                              ...
                              {name}
                                                    ...
                                                    <Popover.Button className="block px-3 py-2 text-xl font-medium rounded-md text-secondary hover:bg-gray-200" as={NavLink} >
                                                        Customise My Plan
                                                    </Popover.Button>
